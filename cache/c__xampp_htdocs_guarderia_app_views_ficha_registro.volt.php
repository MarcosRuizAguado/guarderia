<?php echo $this->tag->stylesheetLink("css/style_formRegistro.css"); ?>
<h2>Añadir/Modificar ficha</h2>
<form action="<?= $this->url->get('ficha/registro') ?>" method="POST">
...
<form action="<?= $this->url->get('ficha/registro') ?>" method="POST">
    ...
    <button type="submit" id="enviar" name="enviar">Rellenar ficha del alumno</button>
    <a id="cancel" href="<?= $this->url->get('ficha/crud') ?>">Cancelar</a>
</form>
<br><br>
